...
public class GenericTest extends BaseTest {
    ...
    @Override
    public void test() throws SourceException {
    ...
    private void test(final String mode, final String expression, final F<?> f, final int x1, final int x2, final int y1, final int y2, final int z1, final int z2) throws SourceException {
    ...
    public static void main(final String[] args) throws SourceException {
        new GenericTest().run();
    }
